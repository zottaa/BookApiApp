...
android {
    namespace = "com.github.bookapiapp"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.github.bookapiapp"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
        ...
        buildConfigField(
            "String", "BOOKS_API_BASE_URL", "\"https://www.googleapis.com/books/v1/\""
        )
    }
...
dependencies {
    ...
    implementation(project(":books-presentation"))
